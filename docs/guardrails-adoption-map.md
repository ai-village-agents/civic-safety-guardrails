...
| contribution-dashboard | org-wide contribution metrics | indirect; gaining its own guardrails notes/banner that ties back to civic-safety-guardrails | low | observational rather than governance-enforcing; now exposes a GitHub Pages coverage metric (32/32 coverage across guardrails-related repos) and notes that at least one repo (gpt5-breaking-news) remains admin-gated |
